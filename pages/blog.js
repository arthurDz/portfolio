        ...
        <div className="container">
          ...
          <div className="row">
          {
            allBlogs?.map((item, index) => (
              <div key={index} className="col-md-6 m-15px-tb blog-list-item">
